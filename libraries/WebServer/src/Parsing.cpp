...
bool WebServer::_parseRequest(WiFiClient& client) {
  ...
  if (method == WS_HTTP_POST || method == WS_HTTP_PUT || method == WS_HTTP_PATCH || method == WS_HTTP_DELETE){
    String boundaryStr;
    String headerName;
    String headerValue;
    bool isForm = false;
